    ...
    public void SeleccionDirecta() {
        ...
        for (int i = 0; i < empleados.length - 1; i++) {
            ...
            for (int j = i + 1; j < empleados.length - 1; j++) {
                ...
                if (empleados[j].getCodigoDelEmpleado() < temp.getCodigoDelEmpleado()) {
                   
                    temp.setCodigoDelEmpleado(empleados[j].getCodigoDelEmpleado());
                    temp.setNombreDelEmpleado(empleados[j].getNombreDelEmpleado());
                    temp.setSueldoDelEmpleado(empleados[j].getSueldoDelEmpleado());
                    k = j;
                }
                comparaciones++;
            }
 
            empleados[k].setCodigoDelEmpleado(empleados[i].getCodigoDelEmpleado());
            empleados[i].setCodigoDelEmpleado(temp.getCodigoDelEmpleado());
            empleados[k].setNombreDelEmpleado(empleados[i].getNombreDelEmpleado());
            empleados[i].setNombreDelEmpleado(temp.getNombreDelEmpleado());
            empleados[k].setSueldoDelEmpleado(empleados[i].getSueldoDelEmpleado());
