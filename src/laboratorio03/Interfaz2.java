...
public final class Interfaz2 extends JFrame implements ActionListener {
    ...
    public Interfaz2() {
        ...
        p.setLayout(null);
        l = new JLabel("Método de la Inseción Directa");
    ...
    public String resultado() {
        ...
        for (int i = 0; i < miEmpresa2.getNumeroDeEmpleados(); i++) {
            ...
            cadena += String.valueOf(miEmpresa2.getCodigoDelEmpleado(i));
            cadena += "</td>";

            cadena += "<td width=\"200\"  rowspan=\"60\"> Nombre : ";
            cadena += String.valueOf(miEmpresa2.getNombreDelEmpleado(i));
            cadena += " </td> ";

            cadena += "<td width=\"200\"  rowspan=\"60\"> Sueldo : ";
            cadena += String.valueOf(miEmpresa2.getSueldoDelEmpleado(i));
            cadena += " </td> ";
            cadena += "</tr>";
            cadena += "</table>";
        }
        ...
        cadena += String.valueOf(miEmpresa2.getComparaciones());
        cadena += "</td>";
        cadena += "</tr>";
        cadena += "<tr>";
        cadena += "<td width=\\\"200\\\"  rowspan=\\\"60\\\">  Número de intercambios : ";
        cadena += String.valueOf(miEmpresa2.getIntercambios());
        cadena += "</td>";
        cadena += "</tr>";
        cadena += "</body></html>";
        return cadena;
